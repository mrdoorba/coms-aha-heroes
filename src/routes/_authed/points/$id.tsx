...
function PointDetailPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-0 min-h-screen bg-background pb-32">
      {/* Header */}
      <div className="sticky top-0 z-10 bg-background/80 backdrop-blur-md px-4 py-3 border-b border-border/50 flex items-center gap-3">
        <Link to="/points">
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-background/80 backdrop-blur-lg border-t border-border/50 max-w-2xl mx-auto z-20">
